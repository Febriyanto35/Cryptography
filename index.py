...
@app.route('/init-db')
def init_db():
    """Endpoint sekali pakai untuk membuat tabel users."""
    try:
        ...
        cur.close()
        conn.close()
        return "Tabel 'users' berhasil dibuat atau sudah ada."
    except Exception as e:
        return f"Terjadi error saat membuat tabel: {e}"

# --- Fungsi Pengiriman Email (tetap sama) ---
...
# --- Rute Aplikasi (dengan logika database) ---
